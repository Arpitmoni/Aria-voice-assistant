...
A Ai voice assistant that works on both **phone and laptop**, installable directly from the browser.

## Features
- *Voice commands** — tap the orb and speak
-**Talks back** — text-to-speech replies
- **Open any website** — YouTube, WhatsApp, Google, Netflix, etc.
-  **Play music** — searches YouTube directly
- **Write emails** — drafts and opens in your mail app
- **Book tickets** — flights, trains, movies via MakeMyTrip / IRCTC / BookMyShow
- **Reminders** — browser notification reminders
-  **Weather, maps, news** — opens Google instantly
